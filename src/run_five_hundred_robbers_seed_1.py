...
source = ROOT / "data/raw/five_hundred_robbers_cave285.jpg"
output_dir = ROOT / "results/five_hundred_robbers_seed_1"
output_dir.mkdir(parents=True, exist_ok=True)

# 固定为 512×512，适配 SD 2 inpainting；原图始终保留，不会被覆盖。
reference = Image.open(source).convert("RGB").resize((512, 512))
mask = Image.new("L", (512, 512), 0)
ImageDraw.Draw(mask).rectangle((256, 128, 384, 256), fill=255)
...
result = pipe(
    prompt=(
        "an ancient Chinese Dunhuang cave mural, Western Wei Dunhuang mural, Five Hundred Robbers story, armored soldiers and horses, weathered mineral pigments, "
...
metadata = {
    "source": "Dunhuang mural Western Wei Dunhuang mural, Five Hundred Robbers story, armored soldiers and horses, weathered mineral pigmentsa; Wikimedia Commons public-domain source",
    "model": "sd2-community/stable-diffusion-2-inpainting",
    "mask": "central 128x128 square at coordinates (192, 192, 320, 320)",
    "seed": 20260921,
    "prompt": "ancient Chinese Dunhuang cave mural, Western Wei Dunhuang mural, Five Hundred Robbers story, armored soldiers and horses, weathered mineral pigments, weathered mineral pigments, historical fresco, highly detailed",
    "steps": 25,
    "guidance_scale": 7.5,
}
