...
source = ROOT / "data/raw/devas_cave272.jpg"
output_dir = ROOT / "results/devas_seed_1"
...
result = pipe(
    prompt=(
        "an ancient Chinese Dunhuang cave mural, heavenly devas, "
...
metadata = {
    "source": "Dunhuang mural heavenly devasa; Wikimedia Commons public-domain source",
    "model": "sd2-community/stable-diffusion-2-inpainting",
    "mask": "central 128x128 square at coordinates (192, 192, 320, 320)",
    "seed": 20260906,
    "prompt": "ancient Chinese Dunhuang cave mural, heavenly devas, weathered mineral pigments, historical fresco, highly detailed",
    "steps": 25,
    "guidance_scale": 7.5,
}
