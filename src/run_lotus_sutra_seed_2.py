...
source = ROOT / "data/raw/lotus_sutra_cave217.png"
output_dir = ROOT / "results/lotus_sutra_seed_2"
...
result = pipe(
    prompt=(
        "an ancient Chinese Dunhuang cave mural, High Tang Dunhuang Lotus Sutra tableau, preaching Buddha with halo and attendants, weathered mineral pigments, "
...
metadata = {
    "source": "Dunhuang mural High Tang Dunhuang Lotus Sutra tableau, preaching Buddha with halo and attendants, weathered mineral pigmentsa; Wikimedia Commons public-domain source",
    "model": "sd2-community/stable-diffusion-2-inpainting",
    "mask": "central 128x128 square at coordinates (192, 192, 320, 320)",
    "seed": 20260928,
    "prompt": "ancient Chinese Dunhuang cave mural, High Tang Dunhuang Lotus Sutra tableau, preaching Buddha with halo and attendants, weathered mineral pigments, weathered mineral pigments, historical fresco, highly detailed",
    "steps": 25,
    "guidance_scale": 7.5,
}
