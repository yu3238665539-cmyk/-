...
source = ROOT / "data/raw/Bhaisajyaguru_mural_from_Mogao_Cave_322,_Dunhuang.jpg"
output_dir = ROOT / "results/bhaisajyaguru_seed_1"
...
result = pipe(
    prompt=(
        "an ancient Chinese Dunhuang cave mural, Bhaisajyaguru (Medicine Buddha), "
...
metadata = {
    "source": "Dunhuang mural Bhaisajyaguru (Medicine Buddha)a; Wikimedia Commons public-domain source",
    "model": "sd2-community/stable-diffusion-2-inpainting",
    "mask": "central 128x128 square at coordinates (192, 192, 320, 320)",
    "seed": 20260908,
    "prompt": "ancient Chinese Dunhuang cave mural, Bhaisajyaguru (Medicine Buddha), weathered mineral pigments, historical fresco, highly detailed",
    "steps": 25,
    "guidance_scale": 7.5,
}
